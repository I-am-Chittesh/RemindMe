  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative bg-gray-50 dark:bg-white/5 backdrop-blur-md border border-gray-300 dark:border-white/10 px-4 py-3 flex items-center gap-3 rounded-apple select-none"
      >
        {/* checkmark */}
        <button
